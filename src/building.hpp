...
class building{
	...
	void help(){
		std::cout <<
				...
				"\n"
				"\tput roomID x y ignition -                   puts an inflamable object on the selected cell, the ignition point is the passed value per 100ºC\n"
				"\n"
				...
				"\ttemperature -                               Temperature counters of the Cell, a fire generates 500 of them each iteration, a temperature counter is like 1ºC\n"
